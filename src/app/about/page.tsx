...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "hardikgothwal0501@gmail.com",
  ...
  },
  {
    ...
    content: "/hardik-gothwal-519821256",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Hardik Gothwal</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Hardik Gothwal, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and 
            ...
            <h2 className="text-2xl mb-6 mt-12">Internships</h2>
