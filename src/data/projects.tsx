...
import {
  RiNextjsFill, RiNodejsFill, RiReactjsFill
} from "react-icons/ri";
import {
  SiChakraui, SiDocker, SiExpress, SiFirebase, SiJavascript,
  SiMongodb, SiPostgresql, SiPrisma, SiPython, SiReactquery,
  SiSanity, SiShadcnui, SiSocketdotio, SiSupabase, SiTailwindcss,
  SiThreedotjs, SiTypescript, SiVuedotjs, SiVite, SiNetlify,
  SiHtml5, SiCss3, SiBootstrap, SiApachemaven, SiCplusplus, SiArduino
} from "react-icons/si";
...
const PROJECT_SKILLS = {
  ...
  openai: { title: "OpenAI", bg: "black", fg: "white", icon: <Image src="/assets/icons/openai-svgrepo-com_white.svg" alt="OpenAI" width={32} height={32} /> },
  ...
  java: { title: "Java", bg: "black", fg: "white", icon: <Image src="/assets/icons/icons8-java.svg" alt="Java" width={32} height={32} /> },
...
const projects: Project[] = [
  {
    ...
    title: "AIFF",
    src: "/assets/projects-screenshots/aiff/1.png",
    screenshots: ["/assets/projects-screenshots/aiff/1.png"],
    skills: {
      frontend: [PROJECT_SKILLS.react],
      backend: [PROJECT_SKILLS.node, PROJECT_SKILLS.python],
    },
    live: "https://github.com/hardik0501/AIFF",
    github: "https://github.com/hardik0501/AIFF",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono">
            AIFF is an advanced audio processing tool leveraging AI to enhance, analyze, and transform audio files.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow images={[`${BASE_PATH}/aiff/1.png`]} />
        </div>
      );
    },
  },
  {
    ...
    title: "Medimate",
    src: "/assets/projects-screenshots/medimate/1.webp",
    screenshots: ["/assets/projects-screenshots/medimate/1.webp"],
    skills: {
      frontend: [PROJECT_SKILLS.react],
      backend: [PROJECT_SKILLS.node, PROJECT_SKILLS.mongo, PROJECT_SKILLS.express],
    },
    live: "https://github.com/hardik0501/Medimate",
    github: "https://github.com/hardik0501/Medimate",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono">
            Medimate is a healthcare platform to manage medications, track health metrics, and connect with doctors.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow images={[`${BASE_PATH}/medimate/1.webp`]} />
        </div>
      );
    },
  },
...
export { projects, PROJECT_SKILLS };
